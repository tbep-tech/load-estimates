...
Source estimates for total nitrogen are shown annually from 1985 to present and by month from 2017 to present (current reasonable assurance period).  The totals tab shows annual results for total nitrogen, hydrologic load, and total nitrogen vs hydrologic load ratios. The load ratio plots show target ratios as horizontal lines that are applicable to each bay segment. 
