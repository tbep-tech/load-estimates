...
```{r}
rct_tab(tndat, dtvar = 'YEAR', typ = 'tn')
```
...
```{r, out.width = '100%', out.height='850px'}
ldtot_plo(totdat, yval = 'tn_load', xval = 'YEAR')
```

### Hydrology

```{r, out.width = '100%', out.height='850px'}
ldtot_plo(totdat, yval = 'hy_load', xval = 'YEAR')
```

### Total Nitrogen vs Hydrology

```{r, out.width = '100%', out.height='850px'}
ldtot_plo(totdat, yval = 'tnhy', xval = 'YEAR', addlns = T)
```

### Table 

```{r}
rct_tab(totdat, dtvar = 'YEAR', typ = 'tots')
```